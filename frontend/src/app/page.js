    ...
    <div className="bg-white">
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl font-bold text-black mb-4">Master LeetCode Problems, Your Way</h1>
      ...
      <section id="features" className="py-16 bg-gray-100">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold text-black mb-8">Why Choose LeetPath?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 border rounded">
              <h3 className="text-2xl font-semibold text-black mb-4">Personalized Problem Recommendations</h3>
            ...
            <div className="p-6 border rounded">
              <h3 className="text-2xl font-semibold text-black mb-4">AI-Powered Insights</h3>
            ...
            <div className="p-6 border rounded">
              <h3 className="text-2xl font-semibold text-black mb-4">Track Your Growth</h3>
      ...
      <section id="about" className="py-16 bg-white">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold text-black mb-8">How Adaptive Learning Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 text-left">
              <h3 className="text-2xl font-semibold text-black mb-4">Adaptive Algorithms</h3>
            ...
            <div className="p-6 text-left">
              <h3 className="text-2xl font-semibold text-black mb-4">Cloud-Powered Scalability</h3>
              <p className="text-gray-600">Hosted on cloud services, our platform scales with your needs, providing a seamless experience whether you’re practicing alone or in a team.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold text-black mb-4">Ready to Boost Your LeetCode Skills?</h2>
