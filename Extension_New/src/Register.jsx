...
import { initializeApp } from 'firebase/app'; // Import initializeApp here
import { useNavigate } from 'react-router-dom'; // Use useNavigate from react-router-dom for navigation
  ...
  return (
    <div className='bg-gray-900 flex flex-col items-center justify-center w-96'>
      <div className='bg-white p-8 rounded-lg shadow-lg max-w-md w-full'>
        ...
        <a href="http://localhost:3000/login" className="flex items-center justify-center bg-red-500 hover:bg-red-700 text-white font-bold w-12 h-12 rounded-lg transition duration-300">
  <FaGoogle className="text-lg" />
</a>

<a href="http://localhost:3000/login" className="flex items-center justify-center bg-blue-600 hover:bg-blue-800 text-white font-bold w-12 h-12 rounded-lg transition duration-300">
  <FaFacebook className="text-lg" />
</a>

<a href="http://localhost:3000/login" className="flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white font-bold w-12 h-12 rounded-lg transition duration-300">
  <FaGithub className="text-lg" />
</a>

<a href="http://localhost:3000/login" className="flex items-center justify-center bg-blue-500 hover:bg-blue-700 text-white font-bold w-12 h-12 rounded-lg transition duration-300">
